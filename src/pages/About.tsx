...
const About = () => {
  ...
  const awards: AwardData[] = [
    ...
    },
    {
      ...
      category: "Cybersecurity Competition",
      description:
        "National recognition for cybersecurity skills, achieving 3rd place in Portugal's skills championship. This prestigious competition brought together the top cybersecurity talent from across the country, testing expertise in ethical hacking, security analysis, digital forensics, and secure network design.",
      images: [`${CDN_BASE_URL}/public/skills-portugal-award.webp`],
      isFeatured: true,
    },
    {
      id: "connexall",
      ...
      description:
        "Received the David Tavares Innovation Award from Connexall for outstanding innovation and technical achievement. This award recognizes exceptional contributions to technology innovation and creative problem-solving in the field of healthcare technology and IoT solutions.",
      images: [
    ...
    },
    {
      ...
      description:
        "Received Merit Award from Ponta Delgada City Hall for outstanding academic performance and contributions to local technology initiatives. This recognition highlights excellence in education and commitment to advancing technology skills in the Azores region.",
      images: [
    ...
    {
      id: "jolera",
      title: "Jolera Merit Awards",
      organization: "Jolera",
      position: "Multiple Merit Awards",
      year: "2024-2026",
      category: "Excellence Recognition",
      description:
        "Received multiple Merit Awards from Jolera recognizing outstanding achievements. In 2024, received recognition as the best student, acknowledging exceptional academic performance, dedication to learning, and outstanding achievements in information technology and cybersecurity. In 2026, received Merit Award Level V for excellence in cybersecurity skills, demonstrating advanced knowledge and practical expertise in the field.",
      images: [
        `${CDN_BASE_URL}/public/merit-jolera.webp`,
        `${CDN_BASE_URL}/public/jolera-merit-award-level-v.webp`,
      ],
    },
    {
      id: "atlantico-junior",
      ...
      description:
        "Achieved 3rd place in the Atlântico Junior FLAD competition for innovation and technical achievement. This competition focused on innovative solutions in networking and technology, showcasing creativity and practical implementation of technical concepts.",
      images: [`${CDN_BASE_URL}/public/atlanticojunior.webp`],
    },
  ];
  ...
  const timeline = [
    {
      ...
      description:
        "Currently pursuing Technical Specialist course in Cybersecurity, building expertise in network security and cloud technologies.",
    },
    {
      year: "2025",
      ...
      description:
        "Currently interning in Cloud Applications, focusing on Software Development and cloud technologies.",
    },
    {
      year: "2025",
      ...
      description:
        "Achieved AWS Solutions Architect Associate certification, demonstrating expertise in designing scalable cloud solutions.",
    },
    {
      year: "2025",
      ...
      company: "Connexall",
      description:
        "Received David Tavares Innovation Award for innovation and technical achievement.",
    },
    {
      year: "April 2025",
      ...
      company: "Amazon Web Services",
      description:
        "Completed AWS Academy Cloud Architecting course, demonstrating expertise in designing scalable cloud solutions.",
    },
    {
      year: "April 2025",
      ...
      company: "Cisco",
      description:
        "Achieved Cisco Certified Network Associate certification, validating expertise in network fundamentals and security.",
    },
    {
      year: "2025",
      ...
      company: "Cisco",
      description:
        "Obtained Cisco Certified Cybersecurity Associate certification, solidifying expertise in cybersecurity operations.",
    },
    {
      year: "2024",
      ...
      description:
        "Competed in cybersecurity skills championship, achieving 2nd place in regional competition.",
    },
    {
      year: "2024",
      ...
      description:
        "National recognition for cybersecurity skills, achieving 3rd place in Portugal's skills championship.",
    },
    {
      year: "2024-2025",
      title: "Merit Awards - Excellence Recognition",
      company: "Jolera & Ponta Delgada City Hall",
      description:
        "Received multiple Merit Awards from Jolera (2024 as best student, 2025 Level V for cybersecurity excellence) and Merit Award from Ponta Delgada City Hall as best student.",
    },
    {
      ...
      description:
        "Completed web development internship with evaluation score: 20/20, working with modern frameworks and agile methodologies.",
    },
    {
      year: "2021-2024",
      ...
      company: "ENTA - Escola de Novas Tecnologias dos Açores",
      description:
        "Completed technical degree focused on network infrastructure, installation and management, providing foundation for cybersecurity career.",
    },
    {
      year: "2022",
      ...
      company: "FLAD",
      description:
        "Achieved 3rd place in innovation and technical achievement competition during networking course.",
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900 transition-colors duration-300">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                Learn more about my journey, skills, certifications, and the
            ...
            <div className="max-w-6xl mx-auto mb-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <motion.div
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.credly.com/badges/0a543b66-5714-4427-9cab-8b9b4a7aaf78/public_url",
                      "_blank",
                    )
                  }
                >
                ...
                <motion.div
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.credly.com/badges/046d471d-c164-4605-8c13-c6395cda5b9a/linked_in_profile",
                      "_blank",
                    )
                  }
                >
                ...
                <motion.div
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.credly.com/badges/890afde7-8cfa-433e-927f-eff02e3c5456/public_url",
                      "_blank",
                    )
                  }
                >
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Recognition for excellence in competitions and academic
                performance
              </p>
            </motion.div>
                  ...
                  >
                    ...
                    >
                      <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md relative">
                        <div
                          className={`absolute top-4 ${index % 2 === 0 ? "left-4" : "right-4"}`}
                        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    current with the latest developments and best practices.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    I believe the best solutions come from working together,
                    sharing knowledge, and leveraging diverse perspectives.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    I'm genuinely passionate about cybersecurity and technology,
                    which drives me to deliver exceptional results.
                  </p>
                </motion.div>
              </div>
            </div>
      ...
      <Dialog
        ...
        onOpenChange={(open) => !open && setSelectedAward(null)}
      >
