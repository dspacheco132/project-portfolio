...
const Resume = () => {
  ...
  const education = [
    {
      ...
      description:
        "Specialized technical training in cybersecurity principles and practices",
    },
    {
      ...
      description:
        "Technical degree focused on network infrastructure, installation and management",
    },
  ];
  ...
  const certifications = [
    {
      ...
      description:
        "CCNA Exam v1.1 (CCNA 200-301) is a 120-minute exam associated with the CCNA certification. This exam tests a candidate's knowledge and skills related to network fundamentals, network access, IP connectivity, IP services, security fundamentals, and automation and programmability.",
    ...
    },
    {
      ...
      date: "Completed",
      description:
        "AWS Solutions Architect Associate certification validates the ability to design and deploy scalable, highly available, and fault-tolerant systems on AWS. Demonstrates expertise in AWS services, security, and best practices for cloud architecture.",
    ...
    },
    {
      ...
      description:
        "This certification validates the skills required of associate-level cyber security analysts within security operations centers.",
    ...
    },
    {
      ...
      date: "Completed",
      description:
        "Successfully completed AWS's 'Getting Started with Compute' training, demonstrating foundational knowledge in various compute types and practical ability to create compute instances using Amazon EC2. This badge validates understanding of core concepts and application of AWS compute services.",
    ...
    },
    {
      ...
      date: "Completed",
      description:
        "Successfully completed the Switching, Routing, and Wireless Essentials course. The earner has a foundation in switching operations, wired and wireless LAN configuration using security best practices, redundancy protocols, and developed problem solving skills. Participated in up to 45 practice activities and accumulated up to 21 hours of hands-on labs using Cisco hardware and/or the Cisco Packet Tracer tool.",
    ...
    },
    {
      ...
      date: "Completed",
      description:
        "Completed cybersecurity awareness training focused on digital citizenship and security best practices.",
      link: null,
    },
  ];
  ...
  const awards = [
    {
      title: "Merit Award - Jolera (Level V)",
      organization: "Jolera",
      year: "2026",
      description: "Recognition for excellence in cybersecurity skills ",
      image:
        "https://r2.diogopacheco.com/public/jolera-merit-award-level-v.webp",
      link: "https://www.linkedin.com/posts/jolera_jolera-azores-itconsulting-activity-7417249162335002624-KVlZ?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEDnZIoBw5rsMG5WzA8fcAYbpm1WzavFHjE",
    },
    {
      ...
      year: "2024",
      description:
        "Recognition for excellence in cybersecurity skills competition",
    ...
    },
    {
      ...
      year: "2024",
      description:
        "Recognition for contributions to local technology initiatives",
    ...
    },
    {
      ...
      year: "2025",
      description:
        "Award for innovation and technical achievement - David Tavares",
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="flex flex-col md:flex-row gap-6 text-gray-600 dark:text-gray-300">
              ...
              <div className="flex items-center">
                ...
                <a
                  href="https://github.com/Swift132"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                >
