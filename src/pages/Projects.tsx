  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300">
                Discover my collection of projects and see what I've been developing
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Projects Filters */}
        <section className="py-8 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
          <div className="container mx-auto px-4">
            ...
            {filteredProjects.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  There are no projects that match the selected filter.
                </p>
                <button
                  onClick={() => setFilter("all")}
